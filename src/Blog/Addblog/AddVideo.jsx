...
function AddVideo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://oviyamedsafe.com/api/addvideo", {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://oviyamedsafe.com/api/video/delete/${id}`, {
        method: "DELETE",
      });
  ...
  const handlePublish = async (id,currentStatus) => {
    try {
      await axios.put(`https://oviyamedsafe.com/api/video/publish/${id}`, {
